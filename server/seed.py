...
with app.app_context():  # ← Everything must be INSIDE this block
    ...
    db.session.add_all([a1, a2, a3])  # ← This MUST be indented inside the with block
    db.session.commit()  # ← This too!